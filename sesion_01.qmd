...
- **Características**:
  ...
  - Enorme ecosistema de bibliotecas.
...
1. **Separación de instrucciones**: Cada línea contiene una instrucción, haciendo el código más legible.  
    - Se utiliza el carácter `;` para separar instrucciones en la misma línea.
2. **Variables**: Los datos pueden almacenarse en variables para usarlos posteriormente.  
   - Una variable es un nombre que comienza con una letra y no contiene espacios. 
3. **Comentarios**: Se utilizan para explicar el código y no se ejecutan.  
   - Comienzan con `#`.
...
# Concatenación
print("Concatenación:", cadena1 + " " + cadena2)  # Salida: Hola Mundo
...
print("¿És Juan mayor que Ana?", juan.es_mayor_de_edad() > ana.es_mayor_de_edad())  # Salida: False
```
...
- Aprender cual es el proceso de análisis de datos.
- Conocer las librerías más utilizadas en Data Science en cada etapa del proceso.
- Realizar un mini-proyecto de análisis de datos.
